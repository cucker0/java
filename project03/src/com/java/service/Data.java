...
public class Data {
    ...
    * */
    ...
    public static final String[][] EQUIPMENT = {
            {"21", "3", "USING", "联想T4", "6000.0"},
            {"21", "1", "FREE", "戴尔", "NEC17寸"},
            {"21", "2", "FREE", "戴尔", "三星 17寸"},
            {"21", "5", "USING", "佳能 2900", "激光"},
            {"21", "4", "FREE", "华硕", "三星 17寸"},
            {"21", "6", "FREE", "华硕", "三星 17寸"},
            {"21", "7", "FREE", "爱普生20K", "针式"},
            {"21", "8", "FREE", "惠普m6", "5800.0"},
            {"21", "9", "FREE", "戴尔", "NEC 17寸"},
            {"21", "10", "FREE", "华硕", "三星 17寸"},
            {"21", "11", "SCRAP", "惠普m6", "5800.0"}
    };
    ...
    * */
    ...
    public static final String[][] TEAMS = {
            {"1", "DevelopmentTeam", "Programmer,3,1", "Designer,2,0", "Architect,1,0"},
