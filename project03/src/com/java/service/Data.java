...
public class Data {
    ...
    //GeneralStaff  :  10, id, teamId, name, sex, age, salary, equipment
    //Programmer:  11, id, teamId, name, sex, age, salary, equipment
    //Designer  :  12, id, teamId, name, sex, age, salary, equipment, bonus
    //Architect :  13, id, teamId, name, sex, age, salary, equipment, bonus, stock
    // equipment, 记录着所有领取设备的SN，SN之间使用","分割
    public static final String[][] EMPLOYEES = {
            {"10", "1", "", "FREE", "马云", "false", "22", "3000", "3,5"},
            {"13", "2", "", "VOCATION", "马化腾", "false", "32", "18000", "", "15000", "2000"},
            {"11", "3", "", "RESIGNED", "李彦宏", "false", "23", "7000", ""},
            {"11", "4", "1", "BUSY", "刘强东", "false", "24", "7300", ""},
            ...
            {"11", "10","",  "FREE", "丁磊", "false", "21", "6600", ""},
            {"11", "11", "FREE", "张朝阳", "false", "25", "7100", ""},
