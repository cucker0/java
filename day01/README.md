...
|类型 |占用存储空间 |表数范围| 默认类型 |末尾加标识 |示例 |
|:---|:---|:---|:---|:---|:---|
|单精度float |4字节 |-3.403E38 ~ 3.403E38,<br>即-2^2<sup>7</sup> ~ 2^2<sup>7</sup>,<br>这里为什么是7,<br>因为指数位(阶码)8位正负符号占一位,<br>精度为6~7位有十进制效数字 | |F 或 f | 5.03F|
|双精度double |8字节 |-1.798E308 ~ 1.798E308, <br>即-2^2<sup>10</sup> ~ 2^2<sup>10</sup>,<br>这里为什么是10,<br>因为指数位11位正负符号占一位,<br>精度为15~16位十进制有效数字 |默认 | | 5.99|
...
* 8进制或16进制转二进制
![8进制或16进制转二进制](./iamges/8进制或16进制转二进制.png)
